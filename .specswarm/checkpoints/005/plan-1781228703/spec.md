...
- The lookup MUST use `scaledIngredients` (which extends `RecipeIngredient` and carries
  `substituteFor: string | null` and `id`). No separate raw-ingredients reference needed.
